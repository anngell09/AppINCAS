...
@app.route('/encoddings', methods=['POST'])
def procesar_imagen():
    global imagen_combinada
...
if existing_descriptor is not None:
    ...
    # Cargar la imagen
  #  imagen = cv2.imread('static/img/IMG-20230827-WA0015.jpg')  # Reemplaza con la ubicación de tu imagen
   

   # Obtener la imagen cargada por el usuario
    archivo = request.files['imagen']

    cara = mtcnn.detect_faces(archivo)
    ...
    if len(cara) > 0:
        ...
        face = archivo[y:y+height, x:x+width]
